...
const artigos: HelpArticle[] = [
  ...
  },
  {
    ...
    steps: [
      ...
      'Para PJ, confira os dados públicos carregados pelo CNPJ e informe separadamente o e-mail, telefone e I.M. usados por sua empresa.',
      'Salve o cadastro e use esse tomador na tela de emissão.',
    ],
    warning: 'A identidade pública da PJ é única por CNPJ e pode ser atualizada para todas as carteiras. E-mail, telefone e I.M. são particulares da sua relação e não alteram outras empresas. Para PF e PJ nacionais, o endereço completo deve estar salvo antes da emissão.',
