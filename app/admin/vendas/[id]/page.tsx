    ...
    <div className="min-h-screen bg-slate-100">
      ...
      <main className="saas-content space-y-6 px-[var(--saas-gutter)] py-6">
        <div className="space-y-6">
          ...
          {activeTab === 'resumo' && (
            <div className="space-y-6">
              <SectionShell title="Operação fiscal" subtitle="Identificação, competência e valores efetivamente usados na DPS." icon={FileText}>
                <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-4">
                  ...
                  <InfoItem label="Competência" value={formData.dataCompetencia || 'Usará data atual'} />
                  <InfoItem label="CNAE" value={formData.cnae || notaAtual?.cnae} mono />
                  <InfoItem label="Valor do serviço" value={formatMoney(venda.valor)} />
                  <InfoItem label="ISS retido" value={formData.issRetido === 'true' ? 'Sim' : 'Não'} />
                  <InfoItem label="Data da venda" value={formatDate(venda.createdAt)} />
                </div>
              </SectionShell>
              ...
              <div className="grid grid-cols-1 xl:grid-cols-2 gap-6">
                ...
                <SectionShell title="Rastreabilidade" subtitle="Linha do tempo técnica e volume de evidências desta venda." icon={History}>
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                    <InfoItem label="Venda criada" value={formatDate(venda.createdAt)} />
                    <InfoItem label="Última atualização" value={formatDate(venda.updatedAt)} />
                    <InfoItem label="Logs registrados" value={venda.logs?.length || 0} />
                    <InfoItem label="Retornos do Portal" value={retornoLogs.length} />
                  </div>
                  <div className="mt-3">
